...
CREATE TABLE `usuarios` (
  ...
  `Usuario_CodigoPostal` varchar(50) NOT NULL,
  `Usuario_Estado` varchar(50) NOT NULL,
  `Usuario_Alcaldia` varchar(50) NOT NULL,
  `Usuario_Colonia` varchar(50) NOT NULL,
  `Usuario_NumInterior` varchar(50) NOT NULL,
  `Usuario_NumExterior` varchar(50) NOT NULL,
