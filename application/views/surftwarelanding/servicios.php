	...
	<div class="center">
		...
		<div class="item__list">
			<div class="item wow flipInY">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_1.png" alt="">
				</figure>
				<div class="title">
			...
			<div class="item wow flipInY" data-wow-delay="0.1s">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_2.png" alt="">
				</figure>
				<div class="title">
			...
			<div class="item wow flipInY" data-wow-delay="0.2s">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_3.png" alt="">
				</figure>
				<div class="title">
			...
			<div class="item wow flipInY" data-wow-delay="0.3s">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_4.png" alt="">
				</figure>
				<div class="title">
			...
			<div class="item wow flipInY" data-wow-delay="0.4s">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_5.png" alt="">
				</figure>
				<div class="title">
			...
			<div class="item wow flipInY" data-wow-delay="0.5s">
				<figure>
					<img src="<?php echo base_url(); ?>public/images/services_icon_6.png" alt="">
				</figure>
				<div class="title">
				...
				<div class="item__part__wrap">
					...
					<div class="item__part">
						<div class="btn__wrap__center">
							<a href="<?php echo base_url();?>index.php/Surftwarelanding/servicios#contacts" class="btn btn__orange btn__large">Solicítalo
								ahora!</a>
						</div>
					</div>
				</div>
...
<div class="section block">
	<div class="container" id="contacts">
		...
		<div class="row">
			...
			<div class="col-md-4 right_side  wow bounceInRight ">
				<div class="text-center">
					<img src="<?php echo base_url(); ?>public/images/contacto-reparacion-computadoras.jpg" class="rounded" alt="">
				</div>
			</div>
		</div>
	</div>
